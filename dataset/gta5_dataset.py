...
class GTA5DataSet(data.Dataset):
    def __init__(self, root, list_path, max_iters=None, crop_size=(321, 321), mean=(128, 128, 128), scale=True,
        ...
        # self.img_ids = [i_id.strip() for i_id in open(list_path)][:2500]
...
if __name__ == '__main__':
    dst = GTA5DataSet(root='/data3/chenlin/data/GTA5', list_path='./gta5_list/train.txt', max_iters=4e4, mean=[0, 0, 0])
